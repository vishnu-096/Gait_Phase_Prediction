...
## Features are dropped in the function "get_train_data_from_df"
...
def get_train_data_from_df(all_data, test_ratio):
    ...
    source_table = source_table.drop(["lgrf", "rgrf", "l_ph_ank", "r_ph_ank","l_ph_fo","r_ph_fo","l_ph_hip","r_ph_hip"], axis = 1)
    x = source_table
...
subject_names = ['AK', 'SD','YC','VN','TH','JL','JS', 'PK', 'SOE','PH','SKS','VP']#,'AK' 'SOE'
sub_comb_list=[]
test_sub_list=[]
acc_list=[]
rmse_list=[]
...
result_path = "/home/vtp/Gait_Phase_Prediction/Results/ver5/"

pkl_file=path+"all_sub_vae2_ver5.pkl"
# pkl_file=path+"good_sub_data.pkl"
result_pkl_file=result_path+'results_ver5.pkl'
...
## I am creating a pickle file with all subjects information. 
## So that we just need to process xl files and create it once. We can load any subject info afterwards from the dictionary in .pkl file
...
## This would probably be the order of features in the training data 
